...
start cmd /k "cd /d Back-End\Honkai-StarBucks_BattleServer\BattleServer && node app.js"

echo Starting LoginServer...
start cmd /k "cd /d Back-End\Honkai-StarBucks_LoginServer\LoginServer && node app.js"
...
start cmd /k "cd /d Back-End\Honkai-StarBucks_TrailBlazersServer\TrailBlazersServer && node app.js"
