...
exports.sumStats = exports.OverallStatList = exports.StatList = void 0;
const config_file_js_1 = require("config_file.js");
const StatProperty_1 = require("../StatProperty");
const RelicSet_1 = __importDefault(require("../relic/RelicSet"));
class CharacterStats {
    constructor(character) {
        ...
        const relicSetsStatProperties = RelicSet_1.default.getActiveSetBonus(character.relics).flatMap(set => set.activeBonus).flatMap(bonus => bonus.stats);
