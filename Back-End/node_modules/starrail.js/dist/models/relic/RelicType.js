...
class RelicType {
    constructor(id, client) {
        ...
        if (!_data)
            throw new AssetsNotFoundError_1.default("RelicType", this.id);
        this._data = _data;
        ...
        this.icon = new ImageAssets_1.default(json.getAsString("BaseTypeIconPath"), this.client);
    }
}
exports.default = RelicType;
