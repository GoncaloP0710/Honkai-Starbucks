...
class RelicExpType {
    constructor(expType, client) {
        ...
        this.client = client;
        const _data = client.cachedAssetsManager.getStarRailCacheData("RelicExpType")[this.expType];
        if (!_data)
            throw new AssetsNotFoundError_1.default("RelicExpType", this.expType);
        this._data = _data;
