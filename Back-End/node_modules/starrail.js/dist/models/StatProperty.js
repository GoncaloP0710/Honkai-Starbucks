...
exports.isStatPropertyType = exports.otherStatPropertyTypes = exports.statPropertyTypes = exports.StatPropertyValue = void 0;
...
class StatProperty {
    constructor(type, client) {
        ...
        if (!_data)
            throw new AssetsNotFoundError_1.default("StatProperty", this.type);
        this._data = _data;
...
class StatPropertyValue {
    constructor(type, value, client) {
        ...
        this.value = value;
        this.nameSkillTree = this.statProperty ? new DynamicTextAssets_1.default(this.statProperty.nameSkillTree.id, { paramList: [value] }, this.client) : null;
    }
    get valueText() {
        if (this.isPercent) {
