...
const LightConeData_1 = __importDefault(require("./LightConeData"));
/**
 * @en
 */
class LightCone {
    constructor(data, client) {
        ...
        this.lightConeData = new LightConeData_1.default(json.getAsNumber("tid"), this.client);
