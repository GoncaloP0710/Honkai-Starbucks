...
exports.LeveledSkillTreeNode = void 0;
...
class LeveledSkillTreeNode extends SkillTreeNode {
    constructor(data, level, client) {
        ...
        this.description = this.levelUpSkills.length > 0 ? this.levelUpSkills[0].getSkillByLevel(level).description
            : (_b = (_a = this.stats[0]) === null || _a === void 0 ? void 0 : _a.nameSkillTree) !== null && _b !== void 0 ? _b : new DynamicTextAssets_1.default((0, hash_utils_1.getStableHash)(json.getAsString("PointDesc")), { paramList: this.paramList }, this.client);
    }
}
