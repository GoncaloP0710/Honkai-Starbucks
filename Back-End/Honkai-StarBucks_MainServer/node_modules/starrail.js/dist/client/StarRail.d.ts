...
import CachedAssetsManager, { LanguageCode } from "starrail.js/dist/client/CachedAssetsManager";
import CharacterData from "starrail.js/dist/models/character/CharacterData";
import { ImageBaseUrl } from "starrail.js/dist/models/assets/ImageAssets";
import LightConeData from "starrail.js/dist/models/light_cone/LightConeData";
import RelicData from "starrail.js/dist/models/relic/RelicData";
import StarRailUser from "starrail.js/dist/models/StarRailUser";
import { EnkaLibrary, EnkaSystem, EnkaGameAccount } from "enka-system";
import StarRailCharacterBuild from "starrail.js/dist/models/enka/StarRailCharacterBuild";
import { Overwrite } from "starrail.js/dist/utils/ts_utils";
...
declare class StarRail implements EnkaLibrary<StarRailUser, StarRailCharacterBuild> {
     ...
     */
    fetchUser(uid: number | string, options?: Partial<FetchOptions>): Promise<StarRailUser>;
    /**
