...
export declare class JsonReader {
    ...
    forEachEntry(callback: (key: string | number, json: JsonReader) => void): void;
    forEachArray(callback: (key: number, json: JsonReader) => void): void;
    forEachObject(callback: (key: string, json: JsonReader) => void): void;
