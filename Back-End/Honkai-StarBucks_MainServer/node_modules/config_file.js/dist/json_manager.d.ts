import { JsonArray, JsonElement, JsonObject } from "config_file.js/dist/json_utils";
export declare class JsonManager {
    private _data;
    get data(): JsonElement;
    set data(value: JsonElement);
    readonly readonly: boolean;
    readonly fastMode: boolean;
    readonly route: (string | number)[];
    protected _currentData: JsonElement | undefined;
    constructor(data: JsonElement, readonly?: boolean, fastMode?: boolean, route?: (string | number)[]);
    set(key: string | number, value: JsonElement): this;
    add(value: JsonElement): this;
    getValue(key?: string | number | undefined, disableFastMode?: boolean): JsonElement | undefined;
    ...
    forEach(callback: (entry: PathResolver) => void): void;
    detach(): JsonManager;
    asObject(): this;
    asArray(): this;
...
export declare class PathResolver extends JsonManager {
