...
import EnkaLibrary, { ExtractBuildType, ExtractUserType } from "enka-system/dist/client/EnkaLibrary";
/** @typedef */
export type GameServerRegion = "" | "CN" | "B" | "NA" | "EU" | "ASIA" | "TW";
/**
 * The game account added to the Enka.Network account.
 */
declare class EnkaGameAccount<T extends EnkaLibrary<User, CharacterBuild>> {
