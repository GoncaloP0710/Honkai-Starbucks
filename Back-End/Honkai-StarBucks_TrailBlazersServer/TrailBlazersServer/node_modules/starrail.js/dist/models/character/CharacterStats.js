...
class CharacterStats {
    constructor(character) {
        ...
        const lightConeStatProperties = [...(character.lightCone?.basicStats ?? []), ...(character.lightCone?.extraStats ?? [])];
...
class StatList {
    ...
    getByType(type) {
        ...
        return this.list[type] ?? new StatProperty_1.StatPropertyValue(type, defaultValue, this.client);
    }
    getAll() {
