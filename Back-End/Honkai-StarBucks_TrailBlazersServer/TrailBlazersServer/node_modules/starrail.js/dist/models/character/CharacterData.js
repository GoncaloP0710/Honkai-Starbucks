...
class CharacterData {
    constructor(id, client) {
        ...
        this.name = new TextAssets_1.TextAssets(json.getAsNumberOrBigint("AvatarName", "Hash"), this.client);
        ...
        const skillTreeJson = new config_file_js_1.JsonReader(CachedAssetsManager_1.excelJsonOptions, skillTreeData);
        ...
        const eidolonsJson = new config_file_js_1.JsonReader(CachedAssetsManager_1.excelJsonOptions, eidolonsData);
