...
class LightConeSuperimposition {
    constructor(id, level, client) {
        ...
        this.description = new DynamicTextAssets_1.DynamicTextAssets(json.getAsNumberOrBigint("SkillDesc", "Hash"), { paramList: this.paramList }, this.client);
