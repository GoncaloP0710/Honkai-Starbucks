...
class RelicSubStatGroup {
    constructor(id, client) {
        this.id = id;
        this.client = client;
        const _data = client.cachedAssetsManager.getStarRailCacheData("RelicSubAffixConfig")[this.id];
        if (!_data)
            throw new AssetsNotFoundError_1.default("RelicSubStatGroup", this.id);
        this._data = _data;
...
exports.default = RelicSubStatGroup;
