...
export declare class StarRail implements EnkaLibrary<StarRailUser, StarRailCharacterBuild> {
    readonly hoyoType: 1;
     ...
     */
    fetchEnkaStarRailBuilds(username: string, hash: string): Promise<Record<string, StarRailCharacterBuild[]>>;
    /**
