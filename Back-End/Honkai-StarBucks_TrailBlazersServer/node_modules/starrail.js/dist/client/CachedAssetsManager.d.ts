import { ConfigFile, FlexJsonArray, FlexJsonElement, FlexJsonObject, JsonObject } from "config_file.js";
...
export declare class CachedAssetsManager {
    ...
    fetchLanguageData(lang: LanguageCode): Promise<JsonObject<string>>;
    /**
