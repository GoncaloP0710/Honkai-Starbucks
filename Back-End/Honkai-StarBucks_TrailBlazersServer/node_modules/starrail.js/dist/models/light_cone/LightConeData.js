...
class LightConeData {
    constructor(id, client) {
        ...
        const json = new config_file_js_1.JsonReader(CachedAssetsManager_1.excelJsonOptions, this._data);
        const itemJson = new config_file_js_1.JsonReader(CachedAssetsManager_1.excelJsonOptions, this._itemData);
        this.name = new TextAssets_1.TextAssets(json.getAsNumberOrBigint("EquipmentName", "Hash"), this.client);
        this.description = new TextAssets_1.TextAssets(itemJson.getAsNumberOrBigint("ItemBGDesc", "Hash"), this.client);
        this.itemDescription = new TextAssets_1.TextAssets(itemJson.getAsNumberOrBigint("ItemDesc", "Hash"), this.client);
    ...
    getStatsByLevel(ascension, level) {
        ...
        const ascensionJson = new config_file_js_1.JsonReader(CachedAssetsManager_1.excelJsonOptions, ascensionData);
        return [
