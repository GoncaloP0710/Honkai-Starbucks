...
class StatProperty {
    constructor(type, client) {
        ...
        this.name = new TextAssets_1.TextAssets(json.getAsNumberOrBigint("PropertyName", "Hash"), this.client);
        const nameSkillTreeHash = json.getAsNumberOrBigintWithDefault(null, "PropertyNameSkillTree", "Hash");
        this.nameSkillTree = nameSkillTreeHash !== null ? new TextAssets_1.TextAssets(nameSkillTreeHash, this.client) : null;
        this.nameRelic = new TextAssets_1.TextAssets(json.getAsNumberOrBigint("PropertyNameRelic", "Hash"), this.client);
        this.nameFilter = new TextAssets_1.TextAssets(json.getAsNumberOrBigint("PropertyNameFilter", "Hash"), this.client);
...
class StatPropertyValue {
    constructor(type, value, client) {
        ...
        this.value = value;
        this.nameSkillTree = this.statProperty && this.statProperty.nameSkillTree ? new DynamicTextAssets_1.DynamicTextAssets(this.statProperty.nameSkillTree.id, { paramList: [value] }, this.client) : null;
    }
    get valueText() {
        if (this.isPercent) {
