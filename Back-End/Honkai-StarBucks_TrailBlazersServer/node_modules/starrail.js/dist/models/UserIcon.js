...
class UserIcon {
    constructor(id, client) {
        ...
        if (!playerIconItem)
            throw new AssetsNotFoundError_1.AssetsNotFoundError("UserIcon-Item", this.id);
        const itemJson = new config_file_js_1.JsonReader(CachedAssetsManager_1.excelJsonOptions, playerIconItem);
        ...
        const iconJson = new config_file_js_1.JsonReader(CachedAssetsManager_1.excelJsonOptions, playerIcon);
